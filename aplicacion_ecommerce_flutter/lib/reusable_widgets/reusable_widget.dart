import 'package:ecommerce_app/pages/comprasUser.dart';
import 'package:ecommerce_app/pages/editProfileScreen.dart';
import 'package:ecommerce_app/pages/editStock.dart';
import 'package:ecommerce_app/pages/home_screen.dart';
import 'package:ecommerce_app/pages/paginaAdmin.dart';
import 'package:ecommerce_app/pages/paginaUser.dart';
import 'package:ecommerce_app/pages/searchUser.dart';
import 'package:ecommerce_app/pages/signin_screen.dart';
import 'package:ecommerce_app/pages/userModifier.dart';
          ...
          onPressed: () {
            FirebaseAuth.instance.signOut().then((value) {
              ...
              Navigator.push(context,
                MaterialPageRoute(builder: (context) => const UserPage()));//UserConfig()));
            });
          },
        ),
        Row(
...
Container simpleButtonWithText(BuildContext context, String text, IconData icon, Function onTap){
  return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          simpleButtonWithText(context, "Carrito de Compras", Icons.shopping_cart, (){
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => HomeScreen()), //CartScreen()),
            );
          }),
        ],
        ),
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          simpleButtonWithText(context, "Bloquear Usuario", Icons.block, () {print("Bloquear Usuario");}),
  ...
  Container UserDataModifier(context,controller1,controller2){
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          //Editar Perfil
          reusableTextField("Editar nombre de usuario", Icons.person, false, controller1),
          SizedBox(height: 20.0),
          reusableTextField("Cambiar password", Icons.password, true, controller2),
          SizedBox(height: 20.0),
            ...
            child: Row(
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, 
                      MaterialPageRoute(builder: (context) => UserPage()));//ProductScreen()),
                  },
                  child: const Text(
                    " Caja Sorpresa",
  ...
  Container StockModifier(context,controller1, controller2, controller3){
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          //Editar Stock
          reusableTextField("Id Producto", Icons.shopping_basket, false, controller3),
          SizedBox(height: 20.0),
