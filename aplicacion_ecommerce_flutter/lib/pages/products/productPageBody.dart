import 'package:aplicacion_ecommerce_flutter/widgets/big_text.dart';
                        ...
                        Row(
                          children: [
                            IconAndText(
                                icon: Icons.circle_sharp,
                                text: "Normal",
                                iconColor: Color.fromARGB(255, 103, 179, 41)),
                            IconAndText(
                                icon: Icons.location_on,
                                text: "1.7km",
                                iconColor: Color.fromARGB(255, 65, 129, 202)),
                            IconAndText(
                                icon: Icons.access_time_rounded,
                                text: "32min",
                                iconColor: Color.fromARGB(255, 185, 30, 103))
                          ],
                        )
                      ],
                    ))))
