...
import 'schema/super_user_record.dart';
...
export 'schema/super_user_record.dart';
...
/// Functions to query SuperUserRecords (as a Stream and as a Future).
Stream<List<SuperUserRecord>> querySuperUserRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SuperUserRecord.collection,
...
Future<List<SuperUserRecord>> querySuperUserRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<SuperUserRecord>> querySuperUserRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
