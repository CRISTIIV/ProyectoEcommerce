...
import '../edit_property1/edit_property1_widget.dart';
import '../flutter_flow/flutter_flow_icon_button.dart';
import '../flutter_flow/flutter_flow_theme.dart';
import '../flutter_flow/flutter_flow_util.dart';
import '../flutter_flow/flutter_flow_widgets.dart';
import '../search_result_admin/search_result_admin_widget.dart';
...
class AdminBusquedaModificarWidget extends StatefulWidget {
  const AdminBusquedaModificarWidget({
    Key? key,
    this.searchTerm,
  }) : super(key: key);
  ...
  @override
  _AdminBusquedaModificarWidgetState createState() =>
      _AdminBusquedaModificarWidgetState();
}

class _AdminBusquedaModificarWidgetState
    extends State<AdminBusquedaModificarWidget> {
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => SearchResultAdminWidget(
